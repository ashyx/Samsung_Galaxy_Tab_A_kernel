...
#MAKE DEFCONFIG
make  msm8916_sec_defconfig VARIANT_DEFCONFIG=msm8916_sec_gt510wifi_eur_defconfig SELINUX_DEFCONFIG=selinux_defconfig
cp $(pwd)/arch/arm/configs/ashyx_gt510wifi_defconfig $(pwd)/.config
