...
#MAKE DEFCONFIG
make  msm8916_sec_defconfig VARIANT_DEFCONFIG=msm8916_sec_gt58lte_eur_defconfig SELINUX_DEFCONFIG=selinux_defconfig
cp $(pwd)/arch/arm/configs/ashyx_gt58lte_defconfig $(pwd)/.config
